...
// get net bootable partition number
// next: start number for search
...
// read sector within a partition, sec_start is the offset into the partition
...
// write sector within a partition, sec_start is the offset into the partition
